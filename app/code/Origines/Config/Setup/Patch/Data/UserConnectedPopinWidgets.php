...
class UserConnectedPopinWidgets extends AbstractPatchData
{
    /**
    ...
    public function apply()
    {
        ...
        //--> Ajout des blocs CMS
        $this->tbdCmsBlock->saveCmsBlock(['client-connecte-panneau-droite', 'client-connecte-offres-exclusives'], 'Origines_Config');
        ...
        $this->createWidget('Client connecté colonne droite', 'client-connecte-panneau-droite', 'customer.connected.popin.right');
        $this->createWidget('Client connecté Offres exclusives', 'client-connecte-offres-exclusives', 'customer.connected.popin.undermenu');
